...
- Modify `src/topic_research/config/agents.yaml` to define your agents
- Modify `src/topic_research/config/tasks.yaml` to define your tasks
- Modify `src/topic_research/crew.py` to add your own logic, tools and specific args
- Modify `src/topic_research/main.py` to add custom inputs for your agents and tasks
...
For support, questions, or feedback regarding the LatestTopicResearch Crew or crewAI.
