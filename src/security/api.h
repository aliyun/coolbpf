...
//	(* NAME)(__VA_ARGS__) __maybe_unused = (void *) bpf_##NAME
//#endif
//
//#ifndef BPF_FUNC2
...
//
///* Memory reads */
//static int BPF_FUNC(bpf_probe_read, void *dst, uint32_t size, const void *src);
//static int BPF_FUNC(bpf_probe_read_str, void *dst, int size, const void *src);
//static int BPF_FUNC(bpf_probe_read_kernel, void *dst, uint32_t size, const void *src);
//
///* Time access */
...
//static uint64_t BPF_FUNC(bpf_get_current_task);
